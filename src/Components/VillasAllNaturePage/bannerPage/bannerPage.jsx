...
import img3 from "../../../assets/home/b7.png";
import img4 from "../../../assets/home/p2.png";
        ...
        <section className="w-full px-2 md:px-4 pt-28 pb-14">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 lg:h-[570px]">
                ...
                <div className="relative overflow-hidden rounded-[20px] border border-white/40 shadow-[0_8px_30px_rgba(0,0,0,0.15)] group">
                    ...
                    {/* Floating Text */}
                    <h1 style={{ fontFamily: "'Futura PT', serif" }} className="absolute top-1/2 left-1/2 translate-x-[-50%] w-full uppercase translate-y-[-50%] text-white text-2xl md:text-4xl lg:text-5xl text-center font-medium tracking-wide [text-shadow:6px_5px_4px_rgba(0,0,0,5)] pointer-events-none">
                        All Nature Villa
                    </h1>
                </div>
