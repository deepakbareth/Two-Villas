// we dont use this we dont need it 
...
import allNatureReviewsData from '../../../Data/VillasAllNatureReviews2';

const VillasAllNatureReviews2 = () => {
    const totalReviews = allNatureReviewsData.length;
    ...
    const sortedReviewsData = [...allNatureReviewsData].sort((a, b) => {
...
export default VillasAllNatureReviews2;