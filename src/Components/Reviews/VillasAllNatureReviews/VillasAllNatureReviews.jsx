...
import allNatureReviewsData from '../../../Data/VillasAllNatureReviews';
// Import a background image for the banner
// import bannerImg from '../../assets/GalleryImg/g1.png';

const VillasAllNatureReviews = () => {
    ...
    const displayedReviews = allNatureReviewsData.slice(0, visibleCount);
...
export default VillasAllNatureReviews;