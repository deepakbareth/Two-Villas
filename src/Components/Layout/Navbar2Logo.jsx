...
import logo from '../../assets/home/websiteLogo6.png';
        ...
        >
            <div className="max-w-[1600px] mx-auto px-6 py-0  lg:px-0">
                <div className="flex justify-between items-center h-15 md:h-13  transition-all duration-500">
                    ...
                    <div className="flex items-end flex-shrink-0 relative md:top-[-20px] top-[-12px] ml-[-15px] md:ml-[-0px]  ">
                        <NavLink to="/twovillas/" className="flex items-end group">
                            ...
                            <span
                                ...
                                className="md:text-[27px] text-[18px] font-bold uppercase tracking-widest  -ml-7 md:-ml-8 md:mb-[-11.5px] mb-[-9px] text-[#705503] [text-shadow:0_2px_4px_rgba(0,0,0,0.4)] "
                            >
                                PREMIUM VILLAS
                            </span>
                        </NavLink>
