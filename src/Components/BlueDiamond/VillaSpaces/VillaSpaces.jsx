...
import { Umbrella, Microwave, Armchair, Flower2 } from 'lucide-react';

const VillaSpaces = () => {
    // Exact content extracted from your screenshot, enhanced with relevant icons
    const spacesList = [
        { id: 1, label: "Deck or patio", Icon: Umbrella },
        { id: 2, label: "Kitchen", Icon: Microwave },
        { id: 3, label: "Number of living rooms", Icon: Armchair },
        { id: 4, label: "Garden", Icon: Flower2 },
    ];
