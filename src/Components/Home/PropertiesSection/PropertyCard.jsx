...
const PropertyCard = ({ property, index }) => {
  ...
  return (
    <div className={`flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-12 lg:gap-20 mb-12`}>
      ...
      <div className="w-full lg:w-[40%] md:text-start text-center  flex flex-col justify-center order-2 lg:order-none">
        ...
        <div className="flex items-center gap-10">
          ...
          <button className="flex items-center gap-2 text-[#c4a661] uppercase tracking-widest text-xs font-bold group">
            ...
            <span className="border-b border-transparent group-hover:border-[#c4a661] md:text-xl text-sm ransition-all">Book Now</span>
          </button>
        </div>
      </div>
